# Durable events, idempotency and server delivery
...
- Добавить idempotency для inbound messages, lifecycle actions, Worker/Turn/Attempt creation, AttemptOutcome и final Result.
...
- Повторный final Result не создаёт новую Conversation entry.
